...
qemu-system-x86_64 \
    ...
    -drive file=ubuntu-20.10-desktop-amd64.iso,index=0,media=cdrom \
    -boot menu=on \
    -drive "if=pflash,format=raw,readonly=on,file=OVMF_CODE.fd" \
    -drive "if=pflash,format=raw,file=OVMF_VARS.fd" \
    -drive file=ubuntu20_10.qcow2,if=virtio,index=1,media=disk,aio=native,cache.direct=on,cache=unsafe \
    -display sdl,gl=on \
    ...
    -nic bridge,br=red_interna1,model=virtio-net-pci,mac=52:54:00:28:12:14 \
